        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="logout"><button type="button" class="btn btn-outline-warning" onclick="location.href='adminlogoutprocess'">로그아웃</button></div>
                    <div class="a_hp">
                        ${sessionScope.a_hp}
                    </div>
                </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a class="menu1-toggle menu-toggle">
                            <i class="material-icons">widgets</i>
                            <span>회원정보</span>
                        </a>
                        
                        <ul class="ml-menu1">
                        	<li><a href="a_userlist">회원목록</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="menu2-toggle menu-toggle">
                            <i class="material-icons" >swap_calls</i>
                            <span>거래내역</span>

                        </a>
                        <ul class="ml-menu2">
                        	<li><a href="a_sale">판매중</a></li>
                        	<li><a href="a_sale_completed">판매완료</a></li>
                        </ul>
